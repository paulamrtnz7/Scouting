...
# 🧾 Cargar DataFrame
if os.path.exists("data/FBREF_players_2223.csv"): df = pd.read_csv("data/FBREF_players_2223.csv", delimiter=";")
df.head()
...
loaded_model = joblib.load("models/modelo_random_forest_TFM.pkl")
...
# =====================
file_path = "data/FBREF_players_2223.csv"
